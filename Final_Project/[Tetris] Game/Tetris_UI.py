...
def normal_mode():
    ...
    while running:
            ...
            if event.type == pygame.KEYDOWN:
                ...
                # 變換方塊-上.
                    ...
                    if (tetris.brick_id == 1 or tetris.brick_id == 2 or tetris.brick_id == 7):
                        ...
                        # 轉換定義方塊到方塊陣列.
                        tetris.transformToBricks()
                        # 碰到磚塊. 不能換
                        if (not tetris.ifTouchBottom()):
        ...
        for y in range(20):
            pos_x = 280
            for x in range(10):
                if(tetris.bricks_array[x][y] != 0):
                    bricks_box[x][y].rect[0] = pos_x
                    bricks_box[x][y].rect[1] = pos_y
                    # ColorVer:依照方塊編號設定顏色.
                    bricks_box[x][y].color = colorVerDict[tetris.bricks_array[x][y]]
        ...
        if(tetris.debug_message == True):
            ...
            for y in range(20):
                str_x = ""
                for x in range(10):
                    str_x = str_x + str(tetris.bricks_array[x][y]) + " "
...
def training_mode():
    ...
    while running:
        ...
        if(time_now >= tetris.brick_down_speed):
            ...
            tetris.container_y = tetris.container_y + 1; 
            # 碰到磚塊.
            if (not tetris.ifTouchBottom() and end == 0):
                #產生新塊.
            ...
            if (not tetris.ifTouchBottom() and end == 1):
                tetris.nextQuiz()  
                end = 0
